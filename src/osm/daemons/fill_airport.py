        ...
        for row in rkt_data:
            ...
            if search_result:
                ...
                if details_result and city_id:
                    iata = details_result["names"]["iata"] if "iata" in details_result["names"] else details_result["names"]["ref"] if "ref" in details_result["names"] and len(details_result["names"]["ref"]) == 3 else row["code_en"]
