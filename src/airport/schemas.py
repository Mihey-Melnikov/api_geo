...
class AirportRead(BaseModel):
    ...
    osm_id: str = Field(..., description="The OpenStreetMap identifier for the airport", example=43102086)
...
class AirportUpdate(BaseModel):
    ...
    osm_id: str | None = Field(None, description="The OpenStreetMap identifier for the airport", example=43102086)
