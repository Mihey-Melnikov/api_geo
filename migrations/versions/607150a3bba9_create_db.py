...
Revision ID: 607150a3bba9
Revises: 
Create Date: 2024-04-22 23:35:22.647177
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_translation_entity_id'), 'translation', ['entity_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_translation_entity_id'), table_name='translation')
